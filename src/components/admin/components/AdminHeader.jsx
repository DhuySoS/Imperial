...
const AdminHeader = () => {
  ...
  return (
    <div className="bg-[#273142] flex items-center justify-around py-4">
      <div className="flex items-center  gap-2 border-gray-300 border rounded-3xl px-4 py-2 text-gray-300 w-[350px]">
        <span>
          <svg
      ...
      <div className="">
        <button
          ...
          className="flex items-center gap-2 p-1 pr-3 rounded-full hover:bg-gray-100/50 transition border border-transparent hover:border-gray-200"
        >
          <img
          ...
          <div className="text-left text-white  hidden md:block">
            <span className=" text-sm block">{user?.name || "Người dùng"}</span>
