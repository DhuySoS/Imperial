...
function Header() {
  ...
  return (
    <div className="sticky top-0 z-50 flex items-center justify-between p-4 bg-white/80 backdrop-blur-sm rounded-b-2xl">
      ...
      <nav className="hidden md:flex items-center gap-8">
        <Link
          to={"/search"}
          className={`text-xl font-semibold transition pb-1 border-b-2 ${
            location.pathname === "/search"
              ? "text-cyan-500 border-cyan-500"
              : "text-gray-800 hover:text-cyan-500 border-transparent"
          }`}
        >
          Khách sạn
        </Link>
